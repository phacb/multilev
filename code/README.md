...
Note. These should be used with micropython 1.22 for the pi pico
Note. The code in slave.py is written to obtain a hardware address for the slave on GPIO26-GPIO28
